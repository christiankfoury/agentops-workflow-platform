            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Format the report as an executive-ready artifact with these "
                        "sections in order: Executive Summary, Priority Table, "
                        "Evidence-Backed Recommendations, Suggested Next Actions, "
                        "Sample-Size Caveat, and Supporting Evidence. The Priority "
                        "Table must separate feature requests by urgency when present: "
                        "SSO as Enterprise blocker, CSV export as Reporting workflow "
                        "need, and shared lists as Collaboration improvement. Clearly "
                        "distinguish urgent bugs from strategic feature requests. "
                        "Mention that the report was generated from human-approved "
                        "analysis. Do not introduce claims that are not supported by "
                        "the source feedback.\n\n"
