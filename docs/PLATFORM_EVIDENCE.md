...
| R14 — accurate positioning and delivery story | [README](../README.md), [overview](overview.md), [specification](PROJECT_SPEC.md), [architecture](ARCHITECTURE.md), [demo script](DEMO_SCRIPT.md) and [reproducible walkthrough](demo-walkthrough.md), [final case study](CASE_STUDY.md); Phases 103–105 | Reconciled documentation, rehearsed script/local fixture, final case study and R01–R14 checklist. [Final evidence review](evidence/phase105/review.json); completion/CI is recorded in the phase ledger. |
